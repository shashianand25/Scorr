        ...
        {showCancelConfirm && (
          <View style={{
            ...
            <View style={{
              ...
              backgroundColor: isDark ? "#161c30" : "#ffffff",
              borderRadius: 24,
              padding: 24,
              borderWidth: 1,
              borderColor: isDark ? "rgba(255,255,255,0.12)" : "rgba(0,0,0,0.08)",
              ...
              <Text style={{
                fontSize: 14, color: isDark ? "rgba(255,255,255,0.7)" : "#64748b",
              ...
              <View style={{ flexDirection: "row", gap: 10, width: "100%" }}>
                ...
                >
                  <Text style={{
                    ...
                    {t('generation.keep_waiting') || "Keep Waiting"}
                  </Text>
                </Pressable>
                ...
                >
                  <Text style={{
                    ...
                    {t('generation.stop_generation') || "Cancel"}
                  </Text>
                </Pressable>
              </View>
            </View>
